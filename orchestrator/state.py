...
# UPDATED: Added pev_contract field (Rule 8: Plans are contracts)
...
class ContinuumState:
    ...
    # Artifacts
    story: Optional[Dict[str, Any]] = None  # {"id": str, "title": str, "acceptance_criteria": [...]}
    contract: Optional[str] = None  # OpenAPI YAML
    schema: Optional[str] = None  # DDL
    dag: Optional[Dict[str, Any]] = None  # Neo4j DAG structure
    code: Optional[Dict[str, str]] = None  # {"path": content}
